...
#' @param specimen_dataset Optional pre-built specimen dataset from
#'   build_specimen_dataset(). Supply it to avoid rebuilding the specimen
#'   hierarchy once per requested output format.
